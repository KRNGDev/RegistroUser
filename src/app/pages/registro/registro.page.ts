...
import { IonContent,IonDatetime, IonThumbnail, IonMenuButton, IonSelectOption, IonSelect, IonHeader, IonTitle, IonToolbar, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonItem, IonLabel, IonButton, IonList, IonIcon, IonAvatar, IonButtons, IonFab, IonFabButton, IonGrid, IonRow, IonCol, IonImg, IonInput } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonInput,IonDatetime, IonThumbnail, IonImg, IonCol, IonRow, IonGrid, IonFabButton, IonFab, IonButtons, IonMenuButton, IonAvatar, IonIcon, IonList, IonButton, IonSelect, IonSelectOption, IonLabel, IonItem, IonCardContent, IonCardTitle, IonCardHeader, IonCard, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
